...
//using SIGA.Identity.Helper;
using SIGA.Identity.Seeds;
using SIGA.Identity.Services;
using SIGA.Identity.Shared.Context;
using SIGA.Identity.Shared.Entities;

namespace SIGA.Identity.Register
{
        ...
        public static async Task RunIdentitySeeds(this IServiceProvider serviceProvider)
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                try
                {
                    ...
                    await DefaultProfesor.SeedAsync(userManager, roleManager);
